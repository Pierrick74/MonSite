    ...
    return <section id="Description" className="items-center">
        <div
            ...
            <div className="bg-zinc-50 p-3 rounded-t-1g xl:w-1/2 px-5 pt-5">
                ...
                <p className="text-justify lg:text-lg 2xl:text-xl xl:my-5 text-zinc-600 font-normal tracking-normal leading-relaxed">
                ...
                <div className="flex flex-wrap md:gap-5 mt-2 items-center mb-3">
                    <p className="p-[1em] md:text-xl 2xl:text-2xl lg:p-0">Faites décoller votre projet&nbsp;!</p>
                    <ContactBtn />
                </div>
            </div>
        </div>
